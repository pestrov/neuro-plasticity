...
const double idW = 0.005;//0.005; // change per non-vetoed spike
const double e_E = 0.01;// Homeostasis rate constant
const double e_I = 0.01;//(.005/10.0); // Homeostasis rate constant TOASK: the same as in excititary?
